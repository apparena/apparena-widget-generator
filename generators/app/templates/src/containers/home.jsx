...
export default connect(
    (state) => ({
        config: state.config,
        answer1Votes: state.answer1Votes,
        answer2Votes: state.answer2Votes,
        answer3Votes: state.answer3Votes,
        answer4Votes: state.answer4Votes,
        appId: state.appId,
        hasVoted: state.hasVoted,
        votedAnswer: state.votedAnswer,
    }),
    (dispatch) => ({
        ...bindActionCreators(voteActions, dispatch)
    })
)(HomeContainer);